...
public interface Parity extends Admin, Trace {
    static Parity build(Chain3jService chain3jService) {
        return new JsonRpc2_0Parity(chain3jService);
    }
    ...
    Request<?, ParityAddressesResponse> parityImportMoacAccounts(ArrayList<String> gethAddresses);
    ...
    Request<?, ParityAddressesResponse> parityListMoacAccounts();
