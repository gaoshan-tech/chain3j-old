...
public class RequestTest extends RequestTester {
    ...
    public void testParityImportMoacAccounts() throws Exception {
        ArrayList<String> moacAccounts = new ArrayList<>();
        moacAccounts.add("0x407d73d8a49eeb85d32cf465507dd71d507100c1");
        chain3j.parityImportMoacAccounts(moacAccounts).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_importMoacAccounts\","
    ...
    public void testParityListMoacAccounts() throws Exception {
        chain3j.parityListMoacAccounts().send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_listMoacAccounts\","
                + "\"params\":[],\"id\":1}");
    }
