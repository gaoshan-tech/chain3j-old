...
public class JsonRpc2_0RxTest {
    ...
    public void testReplayBlocksObservable() throws Exception {
        ...
        CountDownLatch transactionLatch = new CountDownLatch(mcBlocks.size());
        CountDownLatch completedLatch = new CountDownLatch(1);

        List<McBlock> results = new ArrayList<>(mcBlocks.size());
        ...
        assertThat(results, equalTo(mcBlocks));
    ...
    public void testReplayBlocksDescendingObservable() throws Exception {
        ...
        List<McBlock> mcBlocks = Arrays.asList(createBlock(2), createBlock(1), createBlock(0));
    ...
    public void testCatchUpToLatestAndSubscribeToNewBlockObservable() throws Exception {
        ...
        List<McBlock> mcBlocks = Arrays.asList(
                ...
                expected.get(4),  // greatest block
                expected.get(5),  // initial response from mcGetFilterLogs call
        ...
        McFilter mcFilter = objectMapper.readValue(
                "{\n"
                        + "  \"id\":1,\n"
                        + "  \"jsonrpc\": \"2.0\",\n"
                        + "  \"result\": \"0x1\"\n"
