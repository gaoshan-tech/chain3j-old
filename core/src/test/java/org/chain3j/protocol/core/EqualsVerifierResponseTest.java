...
public class EqualsVerifierResponseTest {
    ...
    public void testSolidityInfo() {
        EqualsVerifier.forClass(McCompileSolidity.SolidityInfo.class)
                .suppress(Warning.NONFINAL_FIELDS)
                .suppress(Warning.STRICT_INHERITANCE)
                .verify();
    }
    ...
    public void testCode() {
        EqualsVerifier.forClass(McCompileSolidity.Code.class)
                .suppress(Warning.NONFINAL_FIELDS)
                .suppress(Warning.STRICT_INHERITANCE)
                .verify();
    }
    ...
    public void testDocumentation() {
        EqualsVerifier.forClass(McCompileSolidity.Documentation.class)
                .suppress(Warning.NONFINAL_FIELDS)
                .suppress(Warning.STRICT_INHERITANCE)
                .verify();
    }
