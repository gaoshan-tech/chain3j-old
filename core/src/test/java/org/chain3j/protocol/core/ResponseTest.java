...
public class ResponseTest extends ResponseTester {
    ...
    public void testChain3ClientVersion() {
        ...
        assertThat(chain3ClientVersion.getChainClientVersion(), is("Mist/v0.9.3/darwin/go1.4.1"));
    }
    ...
    public void testMcGasPrice() {
        ...
        McGasPrice ethGasPrice = deserialiseResponse(McGasPrice.class);
    ...
    public void testMcGetTransactionCount() {
        ...
        McGetTransactionCount ethGetTransactionCount =
    ...
    public void testMcSendTransaction() {
        ...
        McSendTransaction ethSendTransaction = deserialiseResponse(McSendTransaction.class);
    ...
    public void testMcSendRawTransaction() {
        ...
        McSendRawTransaction ethSendRawTransaction =
    ...
    @Test
    public void testmcBlockFullTransactionsMoac() {
        //CHECKSTYLE:OFF
        buildResponse(
                "{\n"
                        + "\"id\":1,\n"
    ...
    public void testeEthGetTransactionReceiptBeforeByzantium() {
        ...
        McGetTransactionReceipt ethGetTransactionReceipt = deserialiseResponse(
